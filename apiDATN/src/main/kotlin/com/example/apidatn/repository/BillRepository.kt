...
interface BillRepository:JpaRepository<Bill,Int> {
    ...
    @Query(value ="select distinct bill.* from bill join bill_detail on bill.bill_id =bill_detail.bill_id  join product  on bill_detail.product_id = product.product_id \n" +
